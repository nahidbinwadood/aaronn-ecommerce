  ...
  return (
    <section className="mt-10 container mx-auto">
      <div className="h-full flex gap-6">
        <Link
          to="/welcome-deals"
          className="h-full w-1/2 bg-[#FD384F] rounded-3xl p-16"
        >
          <div className="mt-20 text-center text-white">
            <h1 className="text-6xl mb-3 font-semibold">Welcome deals</h1>
            <p className="text-xl">Your Exclusive Price</p>
          </div>
          <div className="mt-12">
      ...
      <div className="w-full mt-10 bg-[#E9EBF8] rounded-3xl p-8 flex items-center gap-12">
